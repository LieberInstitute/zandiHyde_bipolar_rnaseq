...
#$ -N step5-coverage-zandiHyde_Bipolar
#$ -o ./logs_cov/coverage-hardcoded.$TASK_ID.txt
#$ -e ./logs_cov/coverage-hardcoded.$TASK_ID.txt
#$ -t 1-540
#$ -tc 40
