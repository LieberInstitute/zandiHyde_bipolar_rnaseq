...
load_rse <- function(feat, reg) {
    ...
    load(here("dev_twas", "filter_data", "rda", "amygdala_gene_genePCs.RData"), verbose = TRUE)
    pcs <- genePCs

    ## Emily's PC files have 4 extra brains compared to those generated by filter_snps.R - use her PC file produces an error
...
bim_file <- paste0(
    "/dcl01/lieber/ajaffe/lab/zandiHyde_bipolar_rnaseq/dev_twas/filter_data/unique_snps_bim/LIBD_merged_h650_1M_Omni5M_Onmi2pt5_Macrogen_QuadsPlus_dropBrains_maf01_hwe6_geno10_hg38_filtered_amygdala_gene_uniqueSNPs"
)
