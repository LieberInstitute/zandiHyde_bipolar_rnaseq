...
bim_file <-
    here::here(
        ...
        paste0("LIBD_merged_h650_1M_Omni5M_Onmi2pt5_Macrogen_QuadsPlus_dropBrains_maf01_hwe6_geno10_hg38_filtered_", opt$region, "_gene_uniqueSNPs")
    )

# bim_file <- paste0(
#     "/dcl01/lieber/ajaffe/lab/zandiHyde_bipolar_rnaseq/dev_twas/filter_data/unique_snps_bim/LIBD_merged_h650_1M_Omni5M_Onmi2pt5_Macrogen_QuadsPlus_dropBrains_maf01_hwe6_geno10_hg38_filtered_", opt$region, "_gene_uniqueSNPs"
# )
