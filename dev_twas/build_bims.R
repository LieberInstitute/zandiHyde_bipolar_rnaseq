...
opt$region <- "amygdala" # testing with Amygdala, to be deleted in final version
opt$feature <- "gene"
...
bim_file <- paste0(
    "/users/ylin2/twas/data/genotype/zandiHyde_bipolar_Genotypes_n511_maf005_geno10_hwe1e6_hg38_updated"
)
