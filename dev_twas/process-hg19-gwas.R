...
uniq_bim <- fread("filter_data/unique_snps_bim/LIBD_merged_h650_1M_Omni5M_Onmi2pt5_Macrogen_QuadsPlus_dropBrains_maf01_hwe6_geno10_hg38_filtered_amygdala_gene_uniqueSNPs.bim")
...
hg38_gwas$new_test <- paste0(gsub("chr", "" , hg38_gwas$CHR), "_", hg38_gwas$BP)
...
hg38_gwas <- merge(hg38_gwas[,-"SNP"], uniq_bim[, c("SNP", "new_test")], by = "new_test")

hg38_gwas$new_test <- NULL

col_order <- c(
    "CHR", "SNP", "BP", "A1", "A2", "FRQ_A_20352",
    "FRQ_U_31358", "INFO", "OR", "SE", "P", "ngt", "Direction",
    "HetISqt", "HetDf", "HetPVa", "Nca", "Nco", "Neff")
