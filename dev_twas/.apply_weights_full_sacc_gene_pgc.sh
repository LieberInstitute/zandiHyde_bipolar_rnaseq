...
#$ -N apply_weights_full_sacc_gene_pgc
#$ -o ./logs/apply_weights_full_sacc_gene_pgc.txt
#$ -e ./logs/apply_weights_full_sacc_gene_pgc.txt
#$ -m e
...
Rscript /jhpce/shared/jhpce/libd/fusion_twas/github/fusion_twas/FUSION.assoc_test.R     --sumstats ${summstatsfile}     --weights /dcl01/lieber/ajaffe/lab/zandiHyde_bipolar_rnaseq/dev_twas/sacc_gene/sacc_gene.pos     --weights_dir /dcl01/lieber/ajaffe/lab/zandiHyde_bipolar_rnaseq/dev_twas/sacc_gene/     --ref_ld_chr /dcl01/lieber/ajaffe/lab/brainseq_phase2/twas/reference_hg38/LDREF_hg38/1000G.EUR.     --chr ${chr}     --out sacc_gene/pgc/pgc.${chr}.dat
